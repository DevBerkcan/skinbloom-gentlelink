    ...
    <div className="min-h-screen bg-gradient-to-br from-skinbloom-cream via-skinbloom-grey-50 to-skinbloom-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 ring-1 ring-skinbloom-grey-100">
          <h1 className="text-4xl font-bold text-skinbloom-black mb-8">Impressum</h1>

          <div className="space-y-8 text-skinbloom-grey-700">
            <section>
              <h2 className="text-2xl font-bold text-skinbloom-black mb-4">Angaben gemäß § 5 TMG</h2>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-skinbloom-black mb-4">Kontakt</h2>
              <p className="mb-2">
                <strong>Telefon:</strong> +41 78 241 87 04
              </p>
              <p className="mb-2">
                <strong>E-Mail:</strong>{" "}
                <a href="mailto:info@skinbloom-aesthetics.ch" className="text-skinbloom-black hover:underline">
                  info@skinbloom-aesthetics.ch
                </a>
              </p>
              <p className="mb-2">
                <strong>Website:</strong>{" "}
                <a href="https://www.skinbloom-aesthetics.ch" className="text-skinbloom-black hover:underline">
            ...
            <section>
              ...
              <p className="text-sm text-skinbloom-grey-600 italic mt-2">
            ...
            <section>
              ...
              <p>Inhaberin: [Name bitte eintragen]</p>
              <p>Elisabethenstrasse 41</p>
              <p>4051 Basel, Schweiz</p>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-skinbloom-black mb-4">Haftungsausschluss</h2>

              <h3 className="text-xl font-semibold text-skinbloom-black mt-4 mb-2">Haftung für Inhalte</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-skinbloom-black mt-4 mb-2">Haftung für Links</h3>
              <p className="mb-4">
              ...
              <h3 className="text-xl font-semibold text-skinbloom-black mt-4 mb-2">Urheberrecht</h3>
              <p>
